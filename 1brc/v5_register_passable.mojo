...
fn v5(file_path: String) raises -> String:
    ...
    var city_names = Dict[UInt64, String](power_of_two_initial_capacity=1024)  # Only for final output
    ...
    while start < end:
        ...
        while newlines != 0:
            ...
            if relevant_semicolons != 0:
                ...
                var hash_city = fast_hash(data_ptr + start + start_of_line_idx, city_len)
                ...
                if d.get(hash_city):
                    ...
                    city_names[hash_city] = String(
                        bytes=data[start + start_of_line_idx : start + Int(semicolon_idx)]
                    )
    ...
    var hash_veracruz = fast_hash(veracruz_bytes.unsafe_ptr(), len(veracruz_bytes))
